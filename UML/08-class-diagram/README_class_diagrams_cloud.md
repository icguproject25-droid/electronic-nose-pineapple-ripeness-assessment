...
> 本 README.md 為雲端繳交版，為避免雲端平台無法正確顯示 Markdown 圖片，因此本檔案不直接嵌入圖片路徑，而是以文字列出各 UML 類別圖名稱。
> 若需要對照實際 UML 圖片，請開啟下方 GitHub 連結查看完整圖檔：
> [https://github.com/icguproject25-droid/electronic-nose-pineapple-ripeness-assessment/tree/main/UML](https://github.com/icguproject25-droid/electronic-nose-pineapple-ripeness-assessment/tree/main/UML/08-class-diagram)
...
> 本章節僅列出各類別圖名稱與內容說明。
> 若需要將文字內容與實際圖片進行對照，請至 GitHub UML 資料夾查看完整圖片：
> https://github.com/icguproject25-droid/electronic-nose-pineapple-ripeness-assessment/tree/main/UML

| 編號     | UML 圖名稱               | 內容說明                                      |
| ------ | --------------------- | ----------------------------------------- |
| 8-1 CH | 8-1 Ch08 整體資訊系統類別圖_CH | 中文版整體資訊系統類別圖                              |
| 8-1 EN | 8-1 Ch08 整體資訊系統類別圖_EN | 英文版整體資訊系統類別圖                              |
| 8-2    | 8-2 整體資訊系統類別總覽圖       | 將整體系統濃縮成較容易閱讀的總覽圖                         |
| 8-3    | 8-3 使用者&掃描紀錄&成熟度結果類別圖 | 使用者、消費端掃描、歷史紀錄與成熟度結果                      |
| 8-4    | 8-4 農民端批次&掃描&報表類別圖    | 農民批次管理、批次掃描、統計摘要與報表                       |
| 8-5    | 8-5 系統&感測&校正&推論模型類別圖  | Arduino、Raspberry Pi、感測資料、校正與模型推論         |
| 8-6    | 8-6 照片品種辨識類別圖         | 照片上傳、內容檢查、YOLO 偵測、EfficientNet 分類與 API 回傳 |
...
本章類別圖圖片已整理於 GitHub UML 資料夾中。
為方便對照，本 README.md 僅列出 UML 圖名稱，不直接放入圖片路徑。

```text
8-1 Ch08 整體資訊系統類別圖_CH.png
8-1 Ch08 整體資訊系統類別圖_EN.png
8-2 整體資訊系統類別總覽圖.png
8-3 使用者&掃描紀錄&成熟度結果類別圖.png
8-4 農民端批次&掃描&報表類別圖.png
8-5 系統&感測&校正&推論模型類別圖.png
8-6 照片品種辨識類別圖.png
```
...
若雲端平台無法直接預覽 UML 圖片，請以 GitHub UML 資料夾中的圖片為準：
[https://github.com/icguproject25-droid/electronic-nose-pineapple-ripeness-assessment/tree/main/UML
](https://github.com/icguproject25-droid/electronic-nose-pineapple-ripeness-assessment/tree/main/UML/08-class-diagram)
