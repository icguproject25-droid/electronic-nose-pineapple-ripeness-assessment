...
├──────────────────────────────────────────────────────────────────┤
│                  API 服務層 API Service                           │
│           pineapple_app_gateway  (Flask, Port 5000)              │
│        ┌──────────────────────┬─────────────────────┐           │
│        ▼                      ▼                     ▼            │
│  Raspberry Pi 3         影像辨識伺服器         整合 Web 介面       │
│  pineapple_final        pineapple_detection    pineapple_unified │
│  (inference_30s.py)     (server_variety.py)    _web/app.py       │
├──────────────────────────────────────────────────────────────────┤
│                  感測 / 資料層 Sensing                            │
...
| 影像品種辨識 | `Semester 2 Final Exam (三下-期末)/pineapple_detection/` | YOLOv8 + EfficientNet-B0 伺服器 |
...
## 11. Demo 影片與截圖 Demo Video & Screenshots
